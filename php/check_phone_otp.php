...
if($otp == $_SESSION["phone_verification_otp"])
{

    $_SESSION["user_phone_verified"] = true;
    ...
    if ($result->num_rows > 0)
    {
        ...
        $sql_update = "UPDATE verified_users SET phone_verified=1 WHERE email = '$email'";
    ...
    else
    {
        ...
        $sql_insert = "INSERT INTO verified_users (user_id, firstname, lastname, email, mobile, phone_verified) VALUES ('$user_id', '$fname', '$lname', '$email', '$phone', '1')";        
